      ...
      <div className="bg-aivana-grey rounded-2xl shadow-xl w-full max-w-lg m-4 transform transition-all text-white border border-aivana-light-grey">
        <div className="p-6">
            ...
            <div className="text-sm text-gray-300 space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                <p>
                    <strong>Aivana</strong> is a clinical decision support tool designed to assist healthcare professionals across all medical specialities. Its primary goal is to provide quick, evidence-based information at the point of care, especially in high-pressure or resource-limited settings.
                </p>
                ...
                <div className="p-3 bg-aivana-primary-blue/20 border border-aivana-primary-blue/50 rounded-lg">
                    <h3 className="font-semibold text-white mb-2">Evidence-Based Foundation</h3>
                    <p className="text-xs">
                        The core clinical knowledge base of this application is aligned with the latest guidelines from major national and international health organizations (e.g., WHO, MoHFW, NICE, ACC/AHA). We acknowledge the critical work of expert medical societies worldwide in establishing these standards of care.
                    </p>
                </div>
